...
for n_orders_train in train_list: 
    ...
    np.savetxt(
        f"noncommutativity-order-effects/results/dataset_train_losses-{n_obs}_obs-{n_orders_train}_train.csv",
        a,
    )
    np.savetxt(
        f"noncommutativity-order-effects/results/dataset_train_losses-{n_obs}_obs-{n_orders_train}_test.csv",
        b,
    )
